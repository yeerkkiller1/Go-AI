...
inline bool IsSuicide(Board* board, Pieces type, Loc location, int friendly, int enemy, int empty, Piece* sqrSur[], int cSqrSur, Piece* pieceCur)
{          
  ...
  ctor_FastSetPiece(&libertiesFound);
